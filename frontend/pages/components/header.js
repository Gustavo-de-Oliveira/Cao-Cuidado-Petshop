...
import { faSearch, faUser, faShoppingCart, faFilter } from '@fortawesome/free-solid-svg-icons';
    ...
    <Container>
    	<header>
    		<Navbar bg="dark" expand="lg" fixed="top" className="">
				  <Navbar.Brand href="/"><img src="../../../public/Logo_white.png" className="align-top" width="50px" height="50px" /></Navbar.Brand>
				  ...
				  <Navbar.Collapse id="navbarScroll" className="">
				  	<Row className="col-lg-12">
					    <InputGroup className="my-auto col-lg-5 col-md-7 rounded-0">
						  ...
						  <Container fluid={true} className="col-lg-7 col-md-5 d-flex justify-content-end">
						  	<Nav.Link href="/" className="col-lg-3 col-md-2 col-sm-1 mr-md-5">
					      ...
					      <Nav.Link href="/" className="col-lg-3 col-md-2 col-sm-1">
										<FontAwesomeIcon width="20px" height="20px" icon={ faShoppingCart } />
				  	...
				  	<Form className="col-lg-12">
					  	<Form.Row>
					  			<div className="col-lg-6 d-lg-flex">
					  				<Col>
											<Form.Control size="sm" as="select" className="bg-dark border-0 text-white">
										...
										<Col>
											<Form.Control size="sm" as="select" className="bg-dark border-0 text-white" name="cats" id="cats">
										...
										<Col>
											<Form.Control size="sm" as="select" className="bg-dark border-0 text-white" name="others" id="others">
										...
										<Col>
											<Form.Control size="sm" as="select" className="bg-dark border-0 text-white" name="brands" id="brands">
